...
const RequestId = () => {
    ...
    const inputs = useRef(new Map()).current
                            ...
                            <>
                                {fields.map(({ key, name, ...restField }) => (
                                    <Form.Item key={key} style={{ marginBottom: 0 }}>
                                        ...
                                        >
                                            <Input
                                                placeholder='Трехбуквенный код страны по ISO(Например RUS)'
                                                className='uppercase'
                                            />
                                        </Form.Item>
                                        <div
                ...
                >
                    <Input.Group>
                        ...
                        <Form.Item
                            ...
                            style={{ marginBottom: 0 }}
                        >
                            <Input placeholder='Страна гражданства по ISO 3 символа(Например RUS)' className='uppercase' />
                        </Form.Item>
                        <div
                            style={{ marginBottom: 24 }}
                        >
